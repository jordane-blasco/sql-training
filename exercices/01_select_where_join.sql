...
-- Séance 1 : select/from/where/having/between/order by/avg/count/round/left join
-- Très intéressant : l'ordre d'exécution du code SQL : FROM -> WHERE -> GROUP BY -> HAVING -> SELECT -> ORDER BY
